...
const items = [
  ...
  description: "ChainSight’s API Access empowers developers & businesses to seamlessly integrate our powerful data insights into their own applications. With secure, scalable & easy-to-use API endpoints, you can access real-time data & customize workflows."
 },
