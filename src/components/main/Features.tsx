...
const items = [
  ...
  description: "ChainSight’s API Access empowers developers and businesses to seamlessly integrate our powerful data insights into their own applications. With secure, scalable, and easy-to-use API endpoints, you can access real-time data, and customize workflows."
 },
  ...
  description: "Track, visualize & analyze on-chain data with an easy-to-use, customizable dashboard. Dive into market trends, compare assets & explore unique feeds."
 }
];

const Features = () => {
    const [click, setClick] = useState(0);
    const { name, Icon, description } = items[click];
    return (
        <div>
            <div className='flex items-center justify-center overflow-hidden'>
                <div className='bg-[#040507] flex items-center justify-center rounded-xl w-[90vw] md:w-[80vw] xl:max-w-screen-lg relative'>
                    ...
                    <div className='flex flex-col gap-4 items-center justify-center w-[90%] h-[550px] md:h-[550px] pb-[150px] md:pb-[200px] relative z-50'>
                        ...
                        <div style={{scrollbarWidth: "none"}} className="bg-[#09090B] text-[#FFFFFF] flex gap-4 md:gap-2 rounded-full p-1 overflow-x-scroll overflow-y-hidden h-10 md:overflow-hidden text-sm relative max-w-[98%] md:max-w-[90%] md:w-full">
                            {items.map((item, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="relative cursor-pointer flex justify-center p-3 md:px-1 md:y-2 w-[300px] items-center gap-3"
                                    ...
                                    >
                                        ...
                                        >
                                          <span className='z-10 hidden md:flex transition-all duration-300 w-4 xl:w-3'>{item.Icon}</span> 
                                            <span className="whitespace-nowrap text-md">{item.name}</span>
                                        </span>
                                    </div>
                                );
                            })
                        ...
                        <div className='flex flex-col gap-4 w-[98%] md:max-w-[90%] pb-[70px] md:pb-[40px]'>
