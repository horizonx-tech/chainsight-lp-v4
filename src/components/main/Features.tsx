...
const items = [
  ...
  description: "Gain insights with customizable dashboards built for tokenomics, validator stats, on-chain activity, and user behavior."
 }
];
            ...
            <div className='flex items-center justify-center'>
                <div className='bg-[#040507] flex items-center justify-center rounded-xl max-w-[90vw] md:max-w-[80vw] relative'>
                    ...
                    <div className='flex flex-col gap-4 items-center justify-center w-[90%] relative z-50'>
                        <h2 className='text-[#FAFAFA] text-xl md:text-2xl w-[90%] mt-5'>Tools to Bring Any Data On-chain</h2>
                        <div style={{scrollbarWidth: "none"}} className="bg-[#09090B] text-[#FFFFFF] flex md:gap-2 rounded-full p-1 overflow-x-scroll overflow-y-hidden h-10 md:overflow-hidden text-sm relative max-w-[98%] md:max-w-[90%] md:w-full">
                            {items.map((item, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="relative cursor-pointer flex justify-center px-1 py-2 w-[300px] items-center gap-3"
                                    ...
                                    >
                                        ...
                                        >
                                          <span className='z-10 hidden md:flex transition-all duration-300 w-6'>{item.Icon}</span> 
                        ...
                        <div className='flex flex-col gap-4 w-[98%] md:max-w-[90%]'>
                            ...
                            <div className='text-[#FAFAFA] text-xs w-[85%]'>
                                {description}
                            </div>
                        </div>
                        <img 
