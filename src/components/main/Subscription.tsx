...
const Subscription = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-5 justify-center my-10 px-4'>
      ...
      <div className="bg-[#212123] text-[#A1A1AA] flex gap-2 rounded-full p-0.5 text-xs relative">
          {["Monthly", "Annually"].map((item, index) => (
            <div
              key={index}
              className="relative cursor-pointer p-1.5 px-2"
      ...
      <div className='bg-[#09090B] border border-[#27272A] w-full max-w-5xl rounded-xl h-auto flex flex-col lg:flex-row items-center justify-center p-6 gap-4 text-center lg:text-left'>
